...
TEST_CASE("postgresql query generation", "[pg]") {
    ...
    SECTION("postgresql SELECT query") {
    ...
    SECTION("postgresql INSERT query") {
    ...
    SECTION("postgresql UPDATE query") {
    ...
    SECTION("postgresql REMOVE query", "[pg]") {
