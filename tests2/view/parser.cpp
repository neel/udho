...
TEST_CASE("Parser correctly handles templates with multiple sections", "[template]") {
    ...
    REQUIRE(script[1].type() == udho::view::sections::section::meta);
    REQUIRE(script[1].content() == R"(bridge lua; lang lua)");
    REQUIRE(script[2].type() == udho::view::sections::section::text);
    REQUIRE(script[2].content() == "\n\n        ");
    REQUIRE(script[3].type() == udho::view::sections::section::eval);
    REQUIRE(script[3].content() == "if jit then");
    REQUIRE(script[4].type() == udho::view::sections::section::text);
    REQUIRE(script[4].content() == "\n        LuaJIT is being used\n        LuaJIT version: ");
    REQUIRE(script[5].type() == udho::view::sections::section::echo);
    REQUIRE(script[5].content() == "jit.version");
    REQUIRE(script[6].type() == udho::view::sections::section::text);
    REQUIRE(script[6].content() == "\n        ");
    REQUIRE(script[7].type() == udho::view::sections::section::eval);
    REQUIRE(script[7].content() == "else");
    REQUIRE(script[8].type() == udho::view::sections::section::text);
    REQUIRE(script[8].content() == "\n        LuaJIT is not being used\n        ");
    REQUIRE(script[9].type() == udho::view::sections::section::eval);
    REQUIRE(script[9].content() == "end");
    REQUIRE(script[10].type() == udho::view::sections::section::text);
    REQUIRE(script[10].content() == "\n\n        Hello ");
    REQUIRE(script[11].type() == udho::view::sections::section::echo);
    REQUIRE(script[11].content() == "d.name");
    REQUIRE(script[12].type() == udho::view::sections::section::text);
    REQUIRE(script[12].content() == "\n\n        ");
    REQUIRE(script[13].type() == udho::view::sections::section::embed);
    REQUIRE(script[13].content() == "score udho.view()");
    REQUIRE(script[14].type() == udho::view::sections::section::text);
    REQUIRE(script[14].content() == "\n\n        ");
    REQUIRE(script[15].type() == udho::view::sections::section::comment);
    REQUIRE(script[15].content() == "Some comments that will be ignored");
    REQUIRE(script[16].type() == udho::view::sections::section::text);
    REQUIRE(script[16].content() == "\n\n        ");
    REQUIRE(script[17].type() == udho::view::sections::section::verbatim);
    REQUIRE(script[17].content() == " verbatim block ");
    REQUIRE(script[18].type() == udho::view::sections::section::text);
